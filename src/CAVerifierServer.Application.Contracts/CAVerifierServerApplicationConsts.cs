...
public class CAVerifierServerApplicationConsts
{
    ...
    public const string SecondaryVerifyCodeSubject = "Please Confirm Your Backup Mailbox";
    public const string TransactionBeforeApprovalSubject = "Transaction Notification";
    public const string TransactionAfterApprovalSubject = "Transaction Approved";
}