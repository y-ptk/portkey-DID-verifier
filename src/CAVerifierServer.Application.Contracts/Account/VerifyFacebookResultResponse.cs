...
public class VerifyFacebookResultResponse
{
    [JsonProperty("data")] public VerifyFacebookTokenResponseDto Data { get; set; }
}

public class VerifyFacebookTokenResponseDto
{
